$.getJSON("/api/saved", function(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    $("#articles").append("<div class='mainNews'>" + "<p data-id='" + data[i]._id + "'>" + data[i].title + "<br />" + "</p>" + "<a href='" + data[i].link + " '>" + data[i].link + "</a>" 
      + "<br />" + "<button id='noteSave' class='btn btn-secondary' data-id='" 
